                ...
                <div class="row ed-flex">
                    ...
                    <div class="navbar-collapse1">
                        <ul class="nav navbar-nav ed-ul">
                            ...
                            <li class="visible-xs-inline"><button v-on:click="changeLanguage('vi')"><img src="/images/icon/vn.png" alt=""></button>
                                <button v-on:click="changeLanguage('en')"><img src="/images/icon/en.png" alt=""></button></li>
                        </ul>
                    </div>
                </div>
            </div>
