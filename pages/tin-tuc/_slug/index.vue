            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="titile-news" style="margin-top: 78px;">
                        <h4 v-html="$t('home.news')"></h4>
                    </div>
                    <nuxt-link class="news-aside" v-for="n in  news.news.post_type == 2 ?  news.news_featured.slice(0, 2): news.news_featured" :key="n.id" :to="`/tin-tuc/${n.slug}`">
